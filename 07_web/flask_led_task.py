...
def hello():   
    ...
    <p><a href = "/led/blue/on">BLUE LED ON</a>
    <a href = "/led/blue/off">BLUE LED OFF</a>
     '''  #웹페이지에 보여줄 내용

#동적 라우팅(코드를 간결하게 만들 때 사용할 수 있음)
@app.route("/led/<color>/<op>") #중요한 건 여기! 
def led_op(color, op):    #함수명은 상관 없음(겹치지만 않게!)
    if op == "on" and color == "red": #밖의 라우팅 부분과 안의 함수에서는 변수 공유 안됨
